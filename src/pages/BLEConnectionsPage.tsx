      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-8">
          <div className="p-2 rounded-lg bg-cyber/10 border border-cyber/20">
            <IconBluetooth size={24} className="text-cyber" />
          </div>
          <div>
            <h1 className="text-xl font-medium text-white">BLE Connections</h1>
          ...
          {[1, 2, 3, 4, 5].map((slot) => (
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <button className="btn-ghost text-sm text-white/30 flex items-center gap-1.5">
                  <IconLinkOff size={16} />
